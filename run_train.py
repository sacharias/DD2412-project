...
train_loss, pseudolabel_acc = fixmatch.train(model, labeled_dataloader, unlabled_dataloader, optimizer, args.threshold, args.lambda_u, args.epochs, ema_model, device, log_file=log_file)
